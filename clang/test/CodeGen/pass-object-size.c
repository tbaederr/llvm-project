...
void test2(struct Foo *t) {
  ...
  // CHECK: call i32 @ObjectSize1(ptr noundef %{{.*}}, i64 noundef [[VAR]])
...
void test3(void) {
  ...
  // CHECK: call i32 @_Z27NoViableOverloadObjectSize0PvU17pass_object_size0(ptr noundef %{{.*}}, i64 noundef 360)
  gi = NoViableOverloadObjectSize0(&t[1]);
  // CHECK: call i32 @_Z27NoViableOverloadObjectSize1PvU17pass_object_size1(ptr noundef %{{.*}}, i64 noundef 360)
  gi = NoViableOverloadObjectSize1(&t[1]);
  // CHECK: call i32 @_Z27NoViableOverloadObjectSize2PvU17pass_object_size2(ptr noundef %{{.*}}, i64 noundef 360)
  gi = NoViableOverloadObjectSize2(&t[1]);
  // CHECK: call i32 @_Z27NoViableOverloadObjectSize3PvU17pass_object_size3(ptr noundef %{{.*}}, i64 noundef 360)
  gi = NoViableOverloadObjectSize3(&t[1]);

  // CHECK: call i32 @_Z27NoViableOverloadObjectSize0PvU17pass_object_size0(ptr noundef %{{.*}}, i64 noundef 356)
  gi = NoViableOverloadObjectSize0(&t[1].t[1]);
  // CHECK: call i32 @_Z27NoViableOverloadObjectSize1PvU17pass_object_size1(ptr noundef %{{.*}}, i64 noundef 36)
  gi = NoViableOverloadObjectSize1(&t[1].t[1]);
  // CHECK: call i32 @_Z27NoViableOverloadObjectSize2PvU17pass_object_size2(ptr noundef %{{.*}}, i64 noundef 356)
  ...
  // CHECK: call i32 @_Z34NoViableOverloadDynamicObjectSize0PvU25pass_dynamic_object_size0(ptr noundef %{{.*}}, i64 noundef 360)
...
void test4(struct Foo *t) {
  ...
  gi = NoViableOverloadObjectSize0(&t[1].t[1]);
  // CHECK: [[VAR:%[0-9]+]] = call i64 @llvm.objectsize
  // CHECK: call i32 @_Z27NoViableOverloadObjectSize1PvU17pass_object_size1(ptr noundef %{{.*}}, i64 noundef [[VAR]])
  gi = NoViableOverloadObjectSize1(&t[1].t[1]);
  // CHECK: call i32 @_Z27NoViableOverloadObjectSize2PvU17pass_object_size2(ptr noundef %{{.*}}, i64 noundef %{{.*}})
  gi = NoViableOverloadObjectSize2(&t[1].t[1]);
  // CHECK: call i32 @_Z27NoViableOverloadObjectSize3PvU17pass_object_size3(ptr noundef %{{.*}}, i64 noundef 36)
...
int IndirectObjectSize0(void *const p PS(0)) {
  // CHECK: call i32 @ObjectSize0(ptr noundef %{{.*}}, i64 noundef %{{.*}})
  // CHECK-NOT: @llvm.objectsize
...
int IndirectObjectSize1(void *const p PS(1)) {
  // CHECK: call i32 @ObjectSize1(ptr noundef %{{.*}}, i64 noundef %{{.*}})
  // CHECK-NOT: @llvm.objectsize
...
int IndirectObjectSize2(void *const p PS(2)) {
  // CHECK: call i32 @ObjectSize2(ptr noundef %{{.*}}, i64 noundef %{{.*}})
  // CHECK-NOT: @llvm.objectsize
...
int IndirectObjectSize3(void *const p PS(3)) {
  // CHECK: call i32 @ObjectSize3(ptr noundef %{{.*}}, i64 noundef %{{.*}})
  // CHECK-NOT: @llvm.objectsize
...
void test7(void) {
  ...
  // CHECK: call i32 @"\01Identity"(ptr noundef %{{.*}}, i64 noundef 360)
  ...
  // CHECK: call i32 @"\01Identity"(ptr noundef %{{.*}}, i64 noundef 356)
...
void test9(void *const p __attribute__((pass_object_size(0)))) {
  ...
  // CHECK: call void @DifferingObjectSize3(ptr noundef %{{.*}}, i64 noundef 0)
...
void test14(char *c) {
  // CHECK: @llvm.objectsize
  // CHECK: call void (ptr, i64, ...) @my_sprintf
  my_sprintf(c);
...
// don't turn into ptr s, which caused crashes.
...
void test16(__attribute__((address_space(1))) unsigned *I) {
  // CHECK: call i64 @llvm.objectsize.i64.p1
...
void test17(char *C) {
  ...
  // CHECK: 65535
  // CHECK-NOT: 65535
  // CHECK: @llvm.objectsize.i64.p0(ptr [[PTR:%[^,]+]],
  // CHECK-NOT: 65535
  // CHECK: call i32 @ObjectSize0(ptr noundef [[PTR]]
